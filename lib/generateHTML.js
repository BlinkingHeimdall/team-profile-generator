        ...
        if (employees[i].role === 'Manager') {
            ...
            <div class = "card">
                <div class = "card-header">
                    <h5>${employees[i].empName}</h5>
                    <span class="oi oi-briefcase margin-right: 4rem"></span><span>${employees[i].role}</span>
                </div>
                <div class = "card-body">
            ...
            <div class = "card-header">
                <h5>${employees[i].empName}</h5>
                <span class="oi oi-headphones margin-right: 4rem""></span><span>${employees[i].role}</span>
            </div>
            <div class = "card-body">
                <ul class = "list-group list-group-flush">
            ...
            <div class = "card-header">
                <h5>${employees[i].empName}</h5>
                <span class="oi oi-book margin-right: 4rem""></span><span>${employees[i].role}</span>
            </div>
            <div class = "card-body">
                <ul class = "list-group list-group-flush">
